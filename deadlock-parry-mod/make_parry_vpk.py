...
VARIANT_HEADER = {'01':0,'02':1,'03':2,'04':0,'05':1,'06':3,'07':4}
...
def main():
    ...
    files = {}
    for var, hi in VARIANT_HEADER.items():
        files[f'sounds/player/melee/shared/swing_charged_{var}.vsnd_c'] = hdrs[hi] + payload
